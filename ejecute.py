# execute.py
# cspell: disable
from setup import setup_driver, load_excel, get_current_window_handle
import datetime
import time

# Cargar configuraciones
driver = setup_driver()
df, workbook, sheet = load_excel('data.xlsx')
current_window_handle = get_current_window_handle(driver)
